...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "ธนหทัย คล้ำจีน คือ บุคคลที่เปลี่ยนสีผมทุกไตรมาส",
        "ธนหทัย คล้ำจีน มีชื่อเล่นว่า พลอย เกิดวันที่ 17 พฤศจิกายน 2546 ที่จังหวัดกรุงเทพมหานรค กำลังศึกษามหาวิทยาลัยบูรพา สาขาดทคโนโลยีสารสนเทศ",
        ...
        "ClickNext team AI มี พี่เจ๋ง ทำหน้าที่ Front-end, พี่ปาล์ม ทำหน้าที่ Back-end, พี่ดาว ทำหน้าที่ BA, พี่ออย ทำหน้าที่ BA, พี่ชวน ทำหน้าที่ Data Ops"
    ]
